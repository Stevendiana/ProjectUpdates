...
var TimesheetsComponent = /** @class */ (function () {
    ...
    TimesheetsComponent.prototype.GetWeeklyTimesheets = function (event) {
        this.SetItemActive(event);
    };
    // timesheets type click event function
