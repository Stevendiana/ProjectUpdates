...
@Component({
  ...
  templateUrl: './resources-utilization-table.component.html',
  styleUrls: ['./resources-utilization-table.component.scss']
})
export class ResourcesUtilizationTableComponent implements OnInit {
