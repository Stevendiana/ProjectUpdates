...
@Component({
  ...
  templateUrl: './resources-availability-table.component.html',
  styleUrls: ['./resources-availability-table.component.scss']
})
export class ResourcesAvailabilityTableComponent implements OnInit {
