...
export class NGXToastrService {
    ...
    onSuccessToastr(entity: string) {
      this.toastr.success(`${entity} was succesfully saved to the database.`,
      'Successfully saved', { titleClass: 'h5', 'progressBar': true  });
    }

    onErrorToastr() {
      this.toastr.error(`'Please check your internet connection.'`,
      'Something went wrong', { titleClass: 'h4'  });
    }
