...
import { Mail, Message, MessageDetail, Attachments, TimesheetTotals } from './timesheets.model';
...
export class TimesheetsService {
  ...
  public _timesheets: BehaviorSubject<TimesheetTotals[]>;
  public timesheetsStore: {
  ...
  {
    this.timesheetsStore = { timesheets: [] }; this._timesheets = new BehaviorSubject<TimesheetTotals[]>([]);
  }

  get alltimesheets(): Observable<TimesheetTotals[]> { return this._timesheets.asObservable(); }

  get timesheetsData(): TimesheetTotals[] { return this.timesheetsStore.timesheets; }

  forecastTaskById(id: number) { return this.timesheetsStore.timesheets.find(x => x.calendarTimeId === id); }
  ...
  async getTimesheets() {
    ...
    return this.http.get(this.baseUrl + '/api/timesheetsummary').subscribe(response => {
        this.timesheetsStore.timesheets = response.json();
        this._timesheets.next( Object.assign({}, this.timesheetsStore).timesheets);
        console.log(this.timesheetsStore.timesheets);
    }, error => {
